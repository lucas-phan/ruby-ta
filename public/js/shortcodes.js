...
"use strict";
    theme_counter_init();
    themerex_popup_messages();
    themerex_shortcodes_animation();
});
...
// Popup messages
//-----------------------------------------------------------------
function themerex_popup_messages() {
    "use strict";
...
function themerex_contact_form_send(){
    jQuery('form.contact-form').on('submit', function( e ){
        ...
        var ajax = jQuery.post("/contactus", request)
            .done(function( data ) {
...
function themerex_shortcodes_animation() {
    "use strict";
