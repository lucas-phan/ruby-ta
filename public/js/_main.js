    ...
    ******************************************/
    if (jQuery("#rev_slider_wrapper").length > 0) {
        ...
        jQuery(".tp-bgimg.defaultimg").each(function(){
            jQuery(this).css({'background-image': 'url(' + source +')', 'background-size': '100% auto', 'background-position': '0 0', 'background-repeat': 'no-repeat', 'width': '100%'});
        });
    }
...
function isotope_filters_init() {
    "use strict";
    jQuery("#profile_gallery .isotope_filters").append("<a href=\"#\" data-filter=\"*\" class=\"theme_button active\">Pictures</a>");
}
...
if ((location.pathname.split("/")[1]) !== "") {
    var $a = $('ul.menu_main_nav > li > a[href^="/' + location.pathname.split("/")[1] + '"]');
    $a.closest("li").addClass("current-menu-item");
}
else {
    var a = $('ul.menu_main_nav li a[href^="/"]').eq(0);
    $(a).closest("li").addClass("current-menu-item");
}
